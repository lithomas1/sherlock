import numpy as np
import random
from sherlock.data.datasets import FEVERDataset, ClusterRandomSampler
...
if __name__ == "__main__":
    ...
    sampler = ClusterRandomSampler(dataset, batch_size, True)
